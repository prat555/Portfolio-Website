...
export default function Projects() {
  const projects: Project[] = [
    ...
    },
    {
      ...
      technologies: ["React Native", "Expo", "TypeScript", "Redux", "Tailwind"],
      links: {
            ...
            <CarouselContent>
              {projects.map((project, index) => (
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                  <div
                    className="group bg-white dark:bg-gray-700 rounded-2xl overflow-hidden shadow-lg transition-all duration-300"
                  >
                    <div 
